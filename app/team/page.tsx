...
import { Briefcase, Calendar, ChevronLeftCircle, InfoIcon, LucideGlobe } from 'lucide-react';
                    ...
                    <div className="">
                        <div className="grid items-center gap-10 lg:grid-cols-1">
                            <section className="w-full py-12 md:py-24 lg:py-32">
                                <Link
                                    href={'/about-us'}
                                    className="w-fit mr-auto text-foreground/90 ml-4 mb-4 hover:text-primary transition-all duration-300 ease-in-out-sine"
                                >
