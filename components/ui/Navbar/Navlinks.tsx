        ...
        <div className="relative flex flex-row lg:justify-between justify-center py-4 align-center md:py-4">
            <div className="items-center flex-1 ">
                ...
                >
                    ...
                    {/* <Logo clasName="max-w-[32px] text-primary"/> */}
            ...
            <div className="flex justify-end items-center space-x-2">
                ...
                <DropdownMenu modal={false}>
                    ...
                    <DropdownMenuContent className="w-full min-w-[200px] ">
                            ...
                            <>
                                ...
                                <DropdownMenuItem className="hover:cursor-pointer mb-2">
                                    ...
                                    >
                                        ...
                                        <Button type='submit' className="inline-flex justify-center items-center gap-2 bg-transparent hover:bg-transparent p-0 h-6">
                                            Sign Out
                                        </Button>
                                    </form>
                                </DropdownMenuItem>
                        ...
                        <Link href="/courses">
                            <DropdownMenuItem className="hover:cursor-pointer">
                                <GraduationCap className="size-4 mr-2" /> All
                                Courses
                            </DropdownMenuItem>
                        </Link>
                        <Link href="/growth-sf">
                            <DropdownMenuItem className="hover:cursor-pointer">
                                <MdAutoGraph className="size-4 mr-2" /> Growth
                                SF
                            </DropdownMenuItem>
                        </Link>
                        <Link href="/about-us">
                            <DropdownMenuItem className="hover:cursor-pointer">
                                <InfoIcon className="size-4 mr-2" /> About
                                Us
                            </DropdownMenuItem>
                        </Link>
                        {/* <Link href="/courses">
