          ...
          <div className="container grid items-center gap-8 px-4 text-center md:px-6 lg:grid-cols-[1fr_1fr] lg:gap-16 xl:grid-cols-[1fr_1fr]">
            <div className="space-y-4 p-12 border-primary/50 border-2 rounded-2xl">
              ...
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[600px] text-foreground/40 dark:text-foreground/60 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Our platform adapts to each student's needs, providing
            ...
            <div className="space-y-4 p-12 border-primary/50 border-2 rounded-2xl">
              ...
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[600px] text-foreground/40 dark:text-foreground/60 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Engage with dynamic and interactive course materials that make
            ...
            <div className="space-y-4 p-12 border-primary/50 border-2 rounded-2xl">
              ...
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[600px] text-foreground/40 dark:text-foreground/60 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Students and parents can monitor progress, identify areas for
                  improvement, and celebrate achievements in real time.
                </p>
              </div>
            </div>
            <div className="space-y-4 p-12 border-primary/50 border-2 rounded-2xl">
              ...
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[600px] text-foreground/40 dark:text-foreground/60 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Decription of the above really cool feature. Like its actually
                  so cool. I am just filling up space here. Trust me bro the
                  feature is so cool frfr.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container px-4 md:px-6">
            <div className="grid items-center gap-10 lg:grid-cols-[600px_1fr]">
              <div className="space-y-4">
                <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">
                  “StudyFliss has transformed the way my child learns. The
                  personalized approach has boosted her confidence and made
                  learning enjoyable. Highly recommended!”
                </h2>
                ...
                <div className="container grid items-center gap-16 px-4 md:px-6">
                  <div className="space-y-2 flex flex-col gap-0 justify-center items-center">
                    ...
                    <p className="max-w-[700px] text-center text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                      We're a diverse team of designers, developers, and
                      dreamers, united by our passion for the web.
                    </p>
                  </div>
                  <div className="flex max-w-full mx-auto items-center flex-wrap flex-row gap-6 lg:gap-12">
                    <div className="flex flex-col gap-2">
                      ...
                      <div className="flex flex-col gap-0 items-center">
                        <h3 className="text-xl font-bold">Amitoje Singh</h3>
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      />
                      <div className="flex flex-col gap-0 items-center">
                        <h3 className="text-xl font-bold">Harjot Singh</h3>
                        <p className="text-sm text-gray-500 dark:text-gray-400">
                          Role in the team
                        </p>
                      </div>
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      />
                      <div className="flex flex-col gap-0 items-center">
                        <h3 className="text-xl font-bold">Prabhmeet Singh</h3>
                        <p className="text-sm text-gray-500 dark:text-gray-400">
                          Role in the team
                        </p>
                      </div>
            ...
            <div className="grid gap-10 sm:px-10 md:gap-16 md:grid-cols-2">
              ...
              <div className="flex flex-col items-start space-y-4">
                ...
                <p className="mx-auto max-w-[700px] text-foreground/40 dark:text-foreground/60 md:text-xl/relaxed">
                  Learning should be fun, engaging, and inspiring. At
                  StudyFliss, we're dedicated to creating an educational
                  adventure for every student.
                </p>
                <Link
